...
2. **Decide table strategy:**
   - If the entity logically belongs with existing entities on a shared table (single-table design), use the same table and ensure PK/SK field names match the other entities on that table.
